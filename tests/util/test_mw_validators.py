...
"""Tests for functions in jupyter_matlab_proxy/util/validators.py
"""

import pytest, os, tempfile
from jupyter_matlab_proxy.util import validators
from jupyter_matlab_proxy import mw_environment_variables as mw_env
from jupyter_matlab_proxy.util.exceptions import NetworkLicensingError
...
def test_validate_mlm_license_file_for_invalid_string(monkeypatch):
    ...
    env_name = mw_env.get_env_name_network_license_manager()
