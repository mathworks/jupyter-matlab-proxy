...
describe("Long file", () => {
  it("parses long files correctly", () => {
    ...
    if (tree.toString() != long_file_spec) throw new Error("Parsed tree does not match long file spec")
  })
})
...
describe("Long line", () => {
  it("parses long lines correctly", () => {
    ...
    if (tree.toString() != long_line_spec) throw new Error("Parsed tree does not match long line spec")
  })
})
...
describe("Long file (multiline comment)", () => {
  it("parses long files correctly", () => {
    ...
    if (tree.toString() != "Script(MultilineComment)") throw new Error("Parsed tree does not match long file spec (multiline comment)")
  })
})
...
describe("Long line (multiline comment)", () => {
  it("parses long lines correctly", () => {
    let tree = parser.parse(`%{\n${long_line_input}\n%}`)
    if (tree.toString() != "Script(MultilineComment)") throw new Error("Parsed tree does not match long line spec (multiline comment)")
  })
})
